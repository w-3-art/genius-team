...
- **Autonomy ladder** — L1 suggest-only → L2 draft (default) → L3 apply-low-risk-with-merge-approval → L4 full-auto-with-audit-logs, only if the contract says so. Canonical definitions + promotion rules: `genius-auto` SKILL.md § "Autonomy Ladder."
