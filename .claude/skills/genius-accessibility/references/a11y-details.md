# genius-accessibility — Audit Details (progressive disclosure)

Loaded on demand from `SKILL.md`. Contains the full runnable commands, code patterns,
and checklists for each audit step. `SKILL.md` keeps the step list and thresholds;
read the matching section here before executing a step.
