...
After user approves their design choices, write `playgrounds/templates/design-tokens.css` with their ACTUAL colors:

```css
/* Generated by genius-designer — [Project Name] Design System */
:root {
  /* Brand Colors — FROM USER'S CHOSEN PRESET */
  --color-primary: #[ACTUAL_PRIMARY];       /* e.g. user's chosen accent color */
  --color-primary-hover: #[DARKER_PRIMARY];
  --color-secondary: #[ACTUAL_SECONDARY];
  --color-accent: #[ACTUAL_ACCENT];
  
  /* Backgrounds */
  --color-bg-dark: #[ACTUAL_BG_DARK];
  --color-bg-card: #[ACTUAL_BG_CARD];
  --color-bg-hover: #[ACTUAL_BG_HOVER];
  
  /* Text */
  --color-text: #[ACTUAL_TEXT];
  --color-text-muted: #[ACTUAL_TEXT_MUTED];
  --color-text-dim: #[ACTUAL_TEXT_DIM];
  
  /* Typography */
  --font-family: '[ACTUAL_FONT]', sans-serif;
  --font-size-base: [ACTUAL_BASE]px;
  
  /* Spacing */
  --spacing-unit: [ACTUAL_UNIT]px;
...
This file is used by ALL playground templates. After writing it, all playgrounds will automatically reflect the project's brand colors.
