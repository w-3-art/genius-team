...
const I18N = {
  en: {
    ...
    'team.install.wizard.title': 'Not sure where to start?',
    'team.install.wizard.desc': 'Tell us what you want to do — we\'ll give you the exact one-liner.',
    'team.install.wizard.cta': 'Get started in 3 steps',
    'team.install.manual.toggle': 'Prefer the raw commands? Show manual install',
    'team.install.manual.new': 'New project (replace my-app with your name):',
    'team.install.manual.add': 'Add to existing project (run inside the repo):',
    'team.install.manual.upgrade': 'Upgrade an existing GT install:',
    'team.install.github': 'GitHub repository',
  ...
  fr: {
    ...
    'team.install.wizard.title': 'Tu ne sais pas par où commencer ?',
    'team.install.wizard.desc': 'Dis-nous ce que tu veux faire — on te donne la commande exacte.',
    'team.install.wizard.cta': 'Démarrer en 3 étapes',
    'team.install.manual.toggle': 'Tu préfères les commandes brutes ? Afficher l\u2019install manuelle',
    'team.install.manual.new': 'Nouveau projet (remplace my-app par ton nom) :',
    'team.install.manual.add': 'Ajouter à un projet existant (lance depuis le repo) :',
    'team.install.manual.upgrade': 'Mettre à jour une install GT existante :',
    'team.install.github': 'Repo GitHub',
